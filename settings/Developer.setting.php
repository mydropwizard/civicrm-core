...
return [
  ...
  'fileLogging' => [
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => "Set this value to Yes if you want CiviCRM error/debugging messages to log to files under ConfigAndLog.",
    'help_text' => "Set this value to Yes if you want CiviCRM error/debugging messages to log to files under ConfigAndLog.",
  ],
  'debug_enabled' => [
    'group_name' => 'Developer Preferences',
    'group' => 'developer',
